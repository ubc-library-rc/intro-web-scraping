...
* In Safari and Microsoft Edge *inspect element* is not enabled by default.<br>* To enable in **Safari** go to Preferences -> Advanced and enable *Show Developer menu in menu bar*. <br> * To enable in **Microsoft Edge** press F12
{: .note}
